...
///
/// Resolution order:
/// 1. Runtime values saved from Settings (SharedPreferences)
/// 2. Compile-time `--dart-define=AGRIKHATA_GOOGLE_CLIENT_ID=...`
///
/// Setup:
/// 1. Google Cloud Console → enable "Google Drive API"
/// 2. Credentials → OAuth client ID → Desktop app
/// 3. Paste Client ID (and Secret) in Settings, or via dart-define
