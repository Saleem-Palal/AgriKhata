...
/// Receipt / statement printing with physical ink acknowledgment blocks
/// (Zamindar thumb/sign + shop stamp/sign).
class PrintService {
  PrintService._();
  ...
  static pw.Widget buildA4AcknowledgmentBlock() =>
  ...
  static Future<pw.Document> generateThermalSaleReceiptPdf(
    ...
    final pageHeight = showThumb ? 240.0 : 175.0;
