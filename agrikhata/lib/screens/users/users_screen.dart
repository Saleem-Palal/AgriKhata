                ...
                : _error != null
                    ...
                    : LayoutBuilder(
                        builder: (context, constraints) {
                          final horizontalPad =
                              constraints.maxWidth >= 900 ? 40.0 : 24.0;
      ...
      children: [
        ...
        if (!user.isOwner)
          TextButton(
            ...
            style: TextButton.styleFrom(
              foregroundColor: user.isActive ? _deleteColor : AppColors.darkGreen,
              padding: const EdgeInsets.symmetric(horizontal: 6),
              minimumSize: Size.zero,
              tapTargetSize: MaterialTapTargetSize.shrinkWrap,
            ),
...
class _StaffAccountDialogState extends State<_StaffAccountDialog> {
  ...
  void _submit() {
    ...
    if (_role == UserRole.partner && (_partnerId == null || _partnerId!.isEmpty)) {
